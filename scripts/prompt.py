...
def _build_section_instructions(sections, word_budget, has_meetings, has_slack):
    ...
    section_defs = {
        "executive_summary": (
            "## The Day in Brief\n"
            "3-4 sentences MAX. Lead with the single most important number or signal. "
            "One sentence on what's trending. One sentence on what to watch today. No fluff."
        ),
        "key_signals": (
            "## Key Signals\n"
            "5 one-line signals MAX, each starting with an emoji:\n"
        ...
        "action_items": (
            "## Action Items\n"
            "3-5 bullet points MAX. One line each. Most urgent first. No explanation needed."
        ),
    }
